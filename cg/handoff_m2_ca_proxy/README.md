...
- Divalent ion caveat: the official `martini_v2.0_ions.itp` bundled here does not provide Mg. The `37` requested divalent ions are therefore encoded as the official `CA+` bead as a documented proxy.
